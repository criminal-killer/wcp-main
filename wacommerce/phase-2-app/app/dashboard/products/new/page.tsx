          ...
          {form.type === 'digital' && (
            <div className="bg-blue-50/50 border border-blue-100 p-4 rounded-xl space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <input
                ...
                placeholder="https://download-link.com or License Key"
                ...
                required
              />
              <p className="text-[10px] text-blue-600 font-medium italic">Sent automatically to customer after payment approval.</p>
            </div>
          )}
