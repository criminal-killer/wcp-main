...
export default function InboxClient({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm h-[calc(100vh-200px)] flex overflow-hidden">
      {/* Conversation List */}
      ...
      {selected ? (
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between">
            <div>
              <p className="font-semibold text-gray-900">{selected.contact_name || selected.contact_phone}</p>
