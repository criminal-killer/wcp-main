...
export default async function AdminDashboard() {
  ...
  const distribution = [
    { label: "Starter", key: "starter", color: "bg-emerald-500", price: 29 },
    { label: "Pro", key: "pro", color: "bg-indigo-500", price: 59 },
    { label: "Elite", key: "elite", color: "bg-amber-500", price: 99 },
  ].map(p => {
